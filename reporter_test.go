...
// this is used internally to test both Reporter and BackgroundReporter
func testReporter(config *Config, reporter *Reporter, ts *httptest.Server) {
...
func TestReporter(t *testing.T) {
	Convey("Testing Reporter", t, func(c C) {
		...
		testReporter(config, reporter, ts)
	})
}
